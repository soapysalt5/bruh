...
{isConditionTrue_0 = (gdjs.evtsExt__ArrayTools__IndexOf.func(runtimeScene, runtimeScene.getScene().getVariables().get("__ArrayTools").getChild("Temp"), (typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("Value")) || 0 : 0), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) != -(1));
}
