function createUnityInstance(e, t, r) {
    ...
    return c.SystemInfo = function() {
        ...
        o = h[o] || o, a = document.createElement("canvas"), a && (gl = a.getContext("webgl2"), glVersion = gl ? 2 : 0, gl || (gl = a && a.getContext("webgl")) && (glVersion = 1), gl && (s = gl.getExtension("WEBGL_debug_renderer_info") && gl.getParameter(37446) || gl.getParameter(7937)));
        ...
        function s(s, l) {
            function c(t, r) {
                return u(t, r).then(function(t) {
                    return !g.enabled || g.revalidated ? t : 304 === t.status ? (g.result.revalidated = g.result.accessed, g.revalidated = !0, f.storeRequest(g.result).then(function() {
                    ...
                    }), new n(g.result.response)) : (200 == t.status ? (g.result = o(t.url, g.company, g.product, g.accessed, t), g.revalidated = !0, f.storeRequest(g.result).then(function() {
            ...
            return l && (g.control = l.control, g.company = l.company, g.product = l.product), g.result = o(p, g.company, g.product, Date.now()), g.revalidated = !1, g.enabled ? f.loadRequest(g.result.url).then(function(t) {
                if (!t || t.version !== d.version) return c(s, l);
                g.result = t, g.result.accessed = Date.now();
                var o = new n(g.result.response);
                if ("immutable" == g.control) return g.revalidated = !0, f.storeRequest(g.result), e("'" + g.result.url + "' served from the indexedDB cache without revalidation"), h(o), o;
                if (r(g.result.url) && (o.headers.get("Last-Modified") || o.headers.get("ETag"))) return fetch(g.result.url, {
                    ...
                    }), g.revalidated ? (g.result.revalidated = g.result.accessed, f.storeRequest(g.result), e("'" + g.result.url + "' successfully revalidated and served from the indexedDB cache"), h(o), o) : c(s, l)
                });
                l = l || {};
                var a = l.headers || {};
